...
import { ArrowLeft, MapPin, Clock, Users, Euro, Briefcase, MessageCircle, Music, Dog, Cigarette, Zap, Route, Coffee, Navigation } from "lucide-react"
...
export default function NewTripPage() {
  ...
  const [formData, setFormData] = useState({
    departure: "",
    destination: "",
    departureCoords: { lat: 49.4432, lng: 1.0993 },
    destinationCoords: { lat: 48.8566, lng: 2.3522 },
    dateTime: format(tomorrow, "yyyy-MM-dd'T'HH:mm"),
    seats: 4,
    price: 10,
    description: "",
    meetingPoint: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.response?.data?.errors) {
        ...
        setError(err.response?.data?.error || "Erreur lors de la création du trajet")
      }
    } finally {
      setLoading(false)
    }
      ...
      <div className="bg-gradient-to-b from-primary/5 to-transparent border-b">
        <div className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl md:text-6xl font-bold">Proposer un trajet</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Partagez votre trajet avec d'autres étudiants et réduisez vos frais
            </p>
